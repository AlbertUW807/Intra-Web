...
$total_data = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM insert_voucher WHERE tahap_approve4 = '0' AND tahap_approve3 = '1' AND tahap_approve2 = '1' AND tahap_approve1 = '1' AND Nama_Cabang = '$field_filter'"));
...
$post = mysqli_query($conn, "SELECT id, tanggal, nomorVoucher, Nama_Cabang, case WHEN tahap_approve1 = '0' THEN 'Belum'
														 ...
														 FROM insert_voucher WHERE tahap_approve4 = '0' AND tahap_approve3 = '1' AND tahap_approve2 = '1' AND tahap_approve1 = '1' AND Nama_Cabang = '$field_filter' ORDER BY id DESC
		            ...
		            <nav class="navbar navbar-expand-lg navbar-light">
		              ...
		              <div class="collapse navbar-collapse" id="navbarNavDropdown">
		                <ul class="navbar-nav mr-auto">
		                  ...
		                  <li class="nav-item">
		                    <a class="nav-link" href="directoryH1.php">Directory</a>
		                  </li>
		                  <li class="nav-item">
