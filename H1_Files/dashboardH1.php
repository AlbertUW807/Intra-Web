...
$post = mysqli_query($conn, "SELECT id, tanggal, nomorVoucher, Nama_Cabang, case WHEN tahap_approve1 = '0' THEN 'Belum'
														 ...
														 FROM insert_voucher WHERE tahap_approve4 = '0' AND tahap_approve3 = '1' AND tahap_approve2 = '1' AND tahap_approve1 = '1' AND Nama_Cabang = '$field_cabang' ORDER BY id DESC");

$reject_query = mysqli_query($conn,"SELECT * FROM insert_voucher WHERE tahap_approve4 = '0' AND tahap_approve3 = '1' AND tahap_approve2 = '1' AND tahap_approve1 = '1' AND Nama_Cabang = '$field_cabang' AND reject_bool = '1' ORDER BY id DESC");
