	...
	<div class="container-fluid">
		<div class="container">
			...
			<div class="row">
		      ...
		      <div class="row my-2">
		      	<a href="approve3_RG.php?approve3=<?php echo $row_post["id"]?>" class="btn btn-primary" name="approve">Approve</a>
		      	<a href="reject3_RG.php?reject3=<?php echo $row_post["id"]?>" class="btn btn-primary ml-2">Reject</a>
				...
				<a href="directoryRG.php" class="btn btn-primary mx-2">Back</a>
		      </div>
