...
if(isset($_POST["editVoucher"])){
	...
	mysqli_query($conn, "UPDATE insert_voucher SET currency = '$currency', last_edited = '$tanggal', dari = '$dari',
		nomorVoucher = '$nomorVoucher', deskripsi = '$deskripsi', jumlah = '$jumlah' WHERE id = '$id_edit'");
		      ...
		      <div class="row ROW2">
				  ...
				  <div class="form-row FRow1">
				    ...
				    <div class="col-md-6 my-1">
				      ...
				      <input type="date" class="form-control" id="validationDefault02"value="<?php echo $row_edit["last_edited"]?>" 
