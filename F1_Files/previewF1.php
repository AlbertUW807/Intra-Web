	...
	<div class="container-fluid">
		<div class="container">
			...
			<div class="row">
		      ...
		      <div class="row my-2">
		      	<a href="approve2_F1.php?approve2=<?php echo $row_post["id"]?>" class="btn btn-primary" name="approve">Approve</a>
		      	<a href="reject2_F1.php?reject2=<?php echo $row_post["id"]?>" class="btn btn-primary ml-2" name ="reject">Reject</a>
				...
				<a href="directoryF1.php" class="btn btn-primary mx-2">Back</a>
		      </div>
