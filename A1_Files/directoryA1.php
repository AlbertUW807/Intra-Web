...
$total_data = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM insert_voucher WHERE tahap_approve1 = '0' AND Nama_Cabang = '$field_cabang' AND nomorVoucher LIKE '%$cari%'"));
$total_page = ceil($total_data/$per_page); //round up value
$offset = ($cur_page - 1) * $per_page;
// END OF PAGINATION

$post = mysqli_query($conn, "SELECT id, tanggal, nomorVoucher, Nama_Cabang, 
														 ...
														 FROM insert_voucher WHERE tahap_approve1 = '0' AND Nama_Cabang = '$field_cabang' AND nomorVoucher LIKE '%$cari%' ORDER BY id DESC
		...
		<div class="container">
			...
			<div class="row">
		            ...
		            <nav class="navbar navbar-expand-lg navbar-light">
		              ...
		              <div class="collapse navbar-collapse" id="navbarNavDropdown">
		                <ul class="navbar-nav mr-auto">
		                  <li class="nav-item">
		                    <a class="nav-link" href="dashboardA1.php">Dashboard</a>
		                  </li>
		                  <li class="nav-item">
		                    <a class="nav-link" href="../index.php">Insert Voucher</a>
		                  </li>
		                  <li class="nav-item">
		                    <a class="nav-link" href="directoryA1.php">Pending</a>
		                  </li>
		                  <li class="nav-item">
		                    <a class="nav-link" href="ApprovedA1.php">Approved</a>
		                  </li>
		                </ul>
		      ...
		      <div class="row">
			      ...
			      <a href="directoryA1.php" class="btn btn-outline-success my-2 my-sm-0">Cancel</a>
			    </form>
					  ...
					  <tbody>
					  	...
					  	<?php if(mysqli_num_rows($post)) {?>
						    ...
						    <tr>
						      ...
						      <td>
						      	<a href="previewA1.php?previews=<?php echo $row_post["id"]?>" class="btn btn-primary mb-1">Preview</a>
						      	<a href="edit_A1.php?edits=<?php echo $row_post["id"]?>" class="btn btn-primary mb-1">Edit</a>
						      	<a href="delete_A1.php?deletes=<?php echo $row_post["id"]?>" class="btn btn-primary mb-1">Delete</a>
						      </td>
						...
						<?php if($total_page > 1) {?>
							<nav aria-label="Page navigation example text-center">
							  <ul class="pagination">
							  	<?php if($cur_page > 1) {?>
								    <li class="page-item">
								    	<a href="directoryA1.php?page=<?php echo $cur_page - 1?>" class="page-link" aria-label="Previous">
								...
								<?php if($cur_page < $total_page) {?>
								    <li class="page-item">
								    	<a href="directoryA1.php?page=<?php echo $cur_page + 1?>" class="page-link" aria-label="Next">
