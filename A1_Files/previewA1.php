	...
	<div class="container-fluid">
		<div class="container">
			...
			<div class="row">
		            ...
		            <nav class="navbar navbar-expand-lg navbar-light">
		              ...
		              <div class="collapse navbar-collapse" id="navbarNavDropdown">
		                <ul class="navbar-nav mr-auto">
		                  ...
		                  <li class="nav-item">
		                    <a class="nav-link" href="directoryA1.php">Directory</a>
		                  </li>
		                  <li class="nav-item">
		      ...
		      <div class="row my-3">
		      	<img src="../images/<?php echo $row_post["image"]?>" width="400" class="img-responsive" />
		      </div>

		      <div class="row my-2">
		      	<a href="approve1_A1.php?approve1=<?php echo $row_post["id"]?>" class="btn btn-primary" name="approve">Approve</a>
				<a href="directoryA1.php" class="btn btn-primary mx-2">Back</a>
		      </div>
