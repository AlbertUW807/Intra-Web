	...
	<div class="container-fluid">
		<div class="container">
			...
			<div class="row">
		      ...
		      <div class="row my-2">
		      	<a href="approve7_L1.php?approve7=<?php echo $row_post["id"]?>" class="btn btn-primary" name="approve">Approve</a>
				<a href="directoryL1.php" class="btn btn-primary mx-2">Back</a>
		      </div>
