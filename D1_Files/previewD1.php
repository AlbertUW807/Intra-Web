	...
	<div class="container-fluid">
		<div class="container">
			...
			<div class="row">
		      ...
		      <div class="row my-3">
		      	<img src="../images/<?php echo $row_post["image"]?>" width="500" class="img-responsive" />
		      </div>

		      <div class="row my-2">
		      	<a href="approve6_D1.php?approve6=<?php echo $row_post["id"]?>" class="btn btn-primary" name="approve">Approve</a>
		      	<a href="reject6_D1.php?reject6=<?php echo $row_post["id"]?>" class="btn btn-primary ml-2">Reject</a>
