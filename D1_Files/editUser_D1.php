...
$edit_id = $_GET["edits"];
$edit = mysqli_query($conn, "SELECT * FROM login WHERE id = '$edit_id'");
...
if(isset($_POST["editVoucher"])){
	...
	mysqli_query($conn, "UPDATE login SET username = '$username', password = '$password', email = '$email',
		Nama_Cabang = '$nama_cabang', ApproveLevel = '$approval_level', Regional = '$regional' WHERE id = '$id_edit'");
		      ...
		      <div class="row ROW2">
				  ...
				  <div class="form-row FRow1">
				    <div class="col-md-6 my-1">
				      ...
				      <input type="text" class="form-control" id="validationDefault01" value="<?php echo $row_edit["username"]?>" 
				       name="username" required="">
				    </div>
				    <div class="col-md-6 my-1">
				      <label for="validationDefault02">Password</label>
				      <input type="text" class="form-control" id="validationDefault02"value="<?php echo $row_edit["password"]?>" 
				  ...
				  <div class="form-row FRow2">
				    <div class="col-md-6 my-1">
				      ...
				      <input type="email" class="form-control" id="validationDefault03" value="<?php echo $row_edit["email"]?>" 
				      name="email" required="">
				    </div>
				    <div class="col-md-6 my-1">
				      <label for="validationDefault04">Nama Cabang</label>
				      <input type="text" class="form-control" id="validationDefault04" value="<?php echo $row_edit["Nama_Cabang"]?>"
				      name="nama_cabang">
				  ...
				  <div class="form-row FRow3">
				  	<div class="col-md-12 my-1">
			        	...
			        	<input type="text" id="validationDefault05" class="form-control" value="<?php echo $row_edit["ApproveLevel"]?>" name="approval_level">
				  	</div>
			      </div>
			      ...
			      <div class="form-row FRow4">
			      	<div class="col-md-12 my-1">
			        	...
			        	<input type="text" id="validationDefault06" class="form-control" value="<?php echo $row_edit["Regional"]?>" name="regional">
			      ...
			      <div class="row FRow5 my-3 ml-1">
			      	<input type="submit" name="editVoucher" value="Edit User" class="btn btn-primary">
			      	<a href="userD1.php" class="btn btn-primary mx-2">Back</a>
