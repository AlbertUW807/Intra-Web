...
$total_data = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM insert_voucher WHERE tahap_approve7 = '1' AND nomorVoucher LIKE '%$cari%'"));
$total_page = ceil($total_data/$per_page); //round up value
$offset = ($cur_page - 1) * $per_page;
// END OF PAGINATION

$post = mysqli_query($conn, "SELECT *,case WHEN tahap_approve1 = '0' THEN 'Belum'
														 ...
														 FROM insert_voucher WHERE tahap_approve7 = '1'AND nomorVoucher LIKE '%$cari%' ORDER BY id DESC
			...
			<div class="row">
		            ...
		            <nav class="navbar navbar-expand-lg navbar-light">
		              ...
		              <div class="collapse navbar-collapse" id="navbarNavDropdown">
		                <ul class="navbar-nav mr-auto">
		                  <li class="nav-item">
		                    <a class="nav-link" href="directoryV1.php">Directory</a>
		                  </li>
		                </ul>
		     ...
		     <div class="row">
		     	...
		     	<form class="form-inline my-3" action="" method="post">
			      ...
			      <a href="directoryV1.php" class="btn btn-outline-success my-2 my-sm-0">Cancel</a>
			    </form>
					  	...
					  	<?php if(mysqli_num_rows($post)) {?>
						    ...
						    <tr>
						      ...
						      <td><?php echo $row_post["jumlah"]?></td>
					      	  ...
					      	  <td>
						      	<a href="previewV1.php?previews=<?php echo $row_post["id"]?>" class="btn btn-primary mb-1">Preview</a>
						      </td>
						    </tr>
							<?php $counter++; }?>
						<?php }?>
						...
						<?php if($total_page > 1) {?>
							<nav aria-label="Page navigation example text-center">
							  <ul class="pagination">
							  	<?php if($cur_page > 1) {?>
								    <li class="page-item">
								    	<a href="directoryV1.php?page=<?php echo $cur_page - 1?>" class="page-link" aria-label="Previous">
								...
								<?php if($cur_page < $total_page) {?>
								    <li class="page-item">
								    	<a href="directoryV1.php?page=<?php echo $cur_page + 1?>" class="page-link" aria-label="Next">
