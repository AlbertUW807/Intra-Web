	...
	<div class="container-fluid">
		<div class="container">
			...
			<div class="row">
		      ...
		      <div class="row my-2">
		      	<a href="approve5_H2.php?approve5=<?php echo $row_post["id"]?>" class="btn btn-primary" name="approve">Approve</a>
		      	<a href="reject5_H2.php?reject5=<?php echo $row_post["id"]?>" class="btn btn-primary ml-2">Reject</a>
				...
				<a href="directoryH2.php" class="btn btn-primary mx-2">Back</a>
		      </div>
